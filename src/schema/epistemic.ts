...
export const epistemicEvents = sqliteTable("epistemic_events", {
  ...
  eventType: text("event_type", { enum: ["belief_candidate","tension_candidate","pattern_candidate","hypothesis_candidate","experiment_candidate","experiment_result","doctrine_candidate","axiom_statement","identity_discrepancy","revision_candidate","experiment_completed","doctrine_crystallized","tension_discovered","constitutional_promotion","truth_revision","tension_surfaced"] }).notNull(),

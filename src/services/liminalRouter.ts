...
const SIGNAL_RULES: SignalRule[] = [
  ...
  // ── Small Council: debates, dilemmas, trade-offs ──────────────────────
  {
    ...
    patterns: [
      ...
      /\b(frustrated|lost|tired|stuck|confused|afraid|anxious) but\b/i,
      /\bbut (still|also|yet|somehow|able|willing|hoping|determined)\b/i,
      /\b(want to .+ but|need to .+ but|trying to .+ but)\b/i,
      /\b(even though|despite|in spite of)\b.*\b(I|my)\b/i,
    ],
  },
  ...
  // ── The Interpreter: dreams, symbols, images, recurring motifs ────────
  {
    ...
    patterns: [
      ...
      /\b(vision|visions) (of|about|where|in which)\b/i,
